...
namespace Zenject
{
    ...
    public class IFactoryProvider<TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            var factory = Container.ResolveId(typeof(IZenFactory<TContract>), FactoryId);
            ...
            {
                buffer.Add(((IZenFactory<TContract>)factory).Create());
            }
        }
    }
    ...
    public class IFactoryProvider<TParam1, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TContract>), FactoryId);
            ...
            {
                buffer.Add(((IZenFactory<TParam1, TContract>)factory).Create((TParam1)args[0].Value));
            }
        }
    }
    ...
    public class IFactoryProvider<TParam1, TParam2, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TContract>)factory).Create(
    ...
    public class IFactoryProvider<TParam1, TParam2, TParam3, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TParam3, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TParam3, TContract>)factory).Create(
                        (TParam1)args[0].Value,
                        (TParam2)args[1].Value,
    ...
    public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>)factory).Create(
                        (TParam1)args[0].Value,
                        (TParam2)args[1].Value,
                        (TParam3)args[2].Value,
    ...
    public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>)factory).Create(
                        (TParam1)args[0].Value,
                        (TParam2)args[1].Value,
                        (TParam3)args[2].Value,
                        (TParam4)args[3].Value,
    ...
    public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>)factory).Create(
                        (TParam1)args[0].Value,
                        (TParam2)args[1].Value,
                        (TParam3)args[2].Value,
                        (TParam4)args[3].Value,
    ...
    public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TContract> : IFactoryProviderBase<TContract>
    {
            ...
            InjectContext context, List<TypeValuePair> args, out Action injectAction, List<object> buffer)
        {
            ...
            // Do this even when validating in case it has its own dependencies
            var factory = Container.ResolveId(typeof(IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TContract>), FactoryId);
            ...
            {
                buffer.Add(
                    ((IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TContract>)factory).Create(
                        (TParam1)args[0].Value,
                        (TParam2)args[1].Value,
                        (TParam3)args[2].Value,
                        (TParam4)args[3].Value,
