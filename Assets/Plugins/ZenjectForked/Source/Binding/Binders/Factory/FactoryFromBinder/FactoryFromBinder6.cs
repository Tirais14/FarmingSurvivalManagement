...
namespace Zenject
{
        ...
        : FactoryFromBinderBase
    {
        ...
        public ConditionCopyNonLazyBinder FromFactory<TSubFactory>()
            where TSubFactory : IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>
        {
    ...
    public static class FactoryFromBinder6Extensions
    {
        public static ArgConditionCopyNonLazyBinder FromIFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>(
            ...
            Action<ConcreteBinderGeneric<IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>>> factoryBindGenerator)
        {
            Guid factoryId;
            factoryBindGenerator(
                fromBinder.CreateIFactoryBinder<IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>>(out factoryId));
