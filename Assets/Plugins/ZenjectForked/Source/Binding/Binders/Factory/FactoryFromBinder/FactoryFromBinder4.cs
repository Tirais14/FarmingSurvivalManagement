...
namespace Zenject
{
    ...
    public class FactoryFromBinder<TParam1, TParam2, TParam3, TParam4, TContract> : FactoryFromBinderBase
    {
        ...
        public ConditionCopyNonLazyBinder FromFactory<TSubFactory>()
            where TSubFactory : IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>
        {
    ...
    public static class FactoryFromBinder4Extensions
    {
        public static ArgConditionCopyNonLazyBinder FromIFactory<TParam1, TParam2, TParam3, TParam4, TContract>(
            ...
            Action<ConcreteBinderGeneric<IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>>> factoryBindGenerator)
        {
            Guid factoryId;
            factoryBindGenerator(
                fromBinder.CreateIFactoryBinder<IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>>(out factoryId));
