...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        public DecoratorToChoiceFromBinder<TContract> Decorate<TContract>()
        {
            ...
            bindInfo.ContractTypes.Add(typeof(IZenFactory<TContract, TContract>));
        ...
        FactoryToChoiceIdBinder<TContract> BindFactoryInternal<TContract, TFactoryContract, TFactoryConcrete>()
            where TFactoryConcrete : TFactoryContract, IZenFactory
            where TFactoryContract : IZenFactory
        {
            var statement = StartBinding();
            var bindInfo = statement.SpawnBindInfo();
        ...
        {
            return BindFactoryInternal<TContract, IZenFactory<TContract>, PlaceholderFactory<TContract>>();
        }
        ...
        public FactoryToChoiceIdBinder<TParam1, TContract> BindIFactory<TParam1, TContract>()
        {
            return BindFactoryInternal<
                TParam1, TContract, IZenFactory<TParam1, TContract>, PlaceholderFactory<TParam1, TContract>>();
        }
        ...
        {
            return BindFactoryInternal<
                TParam1, TParam2, TContract, IZenFactory<TParam1, TParam2, TContract>, PlaceholderFactory<TParam1, TParam2, TContract>>();
        }
        ...
        {
            return BindFactoryInternal<
                TParam1, TParam2, TParam3, TContract, IZenFactory<TParam1, TParam2, TParam3, TContract>, PlaceholderFactory<TParam1, TParam2, TParam3, TContract>>();
        }
        ...
        {
            return BindFactoryInternal<
                TParam1, TParam2, TParam3, TParam4, TContract, IZenFactory<TParam1, TParam2, TParam3, TParam4, TContract>, PlaceholderFactory<TParam1, TParam2, TParam3, TParam4, TContract>>();
        }
        ...
        {
            return BindFactoryInternal<
                TParam1, TParam2, TParam3, TParam4, TParam5, TContract, IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>, PlaceholderFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>>();
        }
        ...
        {
            return BindFactoryInternal<
                TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract, IZenFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>, PlaceholderFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>>();
        }
