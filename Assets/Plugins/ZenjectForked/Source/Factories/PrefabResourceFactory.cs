...
namespace Zenject
{
    ...
    //No parameters
    public class PrefabResourceFactory<T> : IZenFactory<string, T>
        //where T : Component
    {
        [Inject]
    ...
    // One parameter
    public class PrefabResourceFactory<P1, T> : IZenFactory<string, P1, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Two parameters
    public class PrefabResourceFactory<P1, P2, T> : IZenFactory<string, P1, P2, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Three parameters
    public class PrefabResourceFactory<P1, P2, P3, T> : IZenFactory<string, P1, P2, P3, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Four parameters
    public class PrefabResourceFactory<P1, P2, P3, P4, T> : IZenFactory<string, P1, P2, P3, P4, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
