...
namespace Zenject
{
    ...
    //No parameters
    public class PrefabFactory<T> : IZenFactory<UnityEngine.Object, T>
        //where T : Component
    {
        [Inject]
    ...
    // One parameter
    public class PrefabFactory<P1, T> : IZenFactory<UnityEngine.Object, P1, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Two parameters
    public class PrefabFactory<P1, P2, T> : IZenFactory<UnityEngine.Object, P1, P2, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Three parameters
    public class PrefabFactory<P1, P2, P3, T> : IZenFactory<UnityEngine.Object, P1, P2, P3, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
    ...
    // Four parameters
    public class PrefabFactory<P1, P2, P3, P4, T> : IZenFactory<UnityEngine.Object, P1, P2, P3, P4, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
